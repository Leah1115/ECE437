...
add wave -noupdate -expand -group dp0 /system_tb/DUT/CPU/DP0/cuif/dWEN
add wave -noupdate -expand -group dp0 /system_tb/DUT/CPU/DP0/cuif/instr
add wave -noupdate -expand -group dp0 /system_tb/DUT/CPU/DP0/pcif/PCEN
add wave -noupdate -expand -group dp0 /system_tb/DUT/CPU/DP0/pcif/npc
add wave -noupdate -expand -group dp0 /system_tb/DUT/CPU/DP0/pcif/pc
add wave -noupdate -expand -group dp1 /system_tb/DUT/CPU/DP1/iiif/out_instr
add wave -noupdate -expand -group dp1 /system_tb/DUT/CPU/DP1/ieif/out_instr
add wave -noupdate -expand -group dp1 /system_tb/DUT/CPU/DP1/emif/out_instr
add wave -noupdate -expand -group dp1 /system_tb/DUT/CPU/DP1/mwif/out_instr
...
add wave -noupdate -expand -group dp1 /system_tb/DUT/CPU/DP1/pcif/pc
...
add wave -noupdate -expand -group icache0 /system_tb/DUT/CPU/CM0/ICACHE/cache_table
add wave -noupdate -expand -group icache0 /system_tb/DUT/CPU/CM0/ICACHE/imemaddr
add wave -noupdate -expand -group icache0 /system_tb/DUT/CPU/CM0/ICACHE/index
add wave -noupdate -expand -group icache0 /system_tb/DUT/CPU/CM0/ICACHE/hit_en
...
add wave -noupdate -expand -group icache1 /system_tb/DUT/CPU/CM1/ICACHE/cache_table
add wave -noupdate -expand -group icache1 /system_tb/DUT/CPU/CM1/ICACHE/imemaddr
add wave -noupdate -expand -group icache1 /system_tb/DUT/CPU/CM1/ICACHE/index
add wave -noupdate -expand -group icache1 /system_tb/DUT/CPU/CM1/ICACHE/hit_en
...
WaveRestoreCursors {{Cursor 1} {433508 ps} 0}
...
update
WaveRestoreZoom {0 ps} {664902 ps}
